...
def normalize_cnpjws(d):
    ...
    return {
        ...
        "cep": est.get("cep", "") or "",
        "logradouro": (est.get("tipo_logradouro", "") + " " + est.get("logradouro", "")).strip(),
        ...
        "socio_principal": socios[0].get("nome", "") if socios else "",
        "fonte_enriq": "cnpjws",
    }
...
def normalize_brasilapi(d):
    ...
    return {
        ...
        "socio_principal": socios[0].get("nome_socio", "") if socios else "",
